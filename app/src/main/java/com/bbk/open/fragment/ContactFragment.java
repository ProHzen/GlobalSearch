 ...
 */
public class ContactFragment extends Fragment implements View.OnTouchListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public void updateContent(String content) {
        if (TextUtils.isEmpty(content)) {
            ...
            FilesDao dao = new FilesDao(context);
            try {
                result = dao.qurry(content, FileInfo.TYPE_CONTACT);
