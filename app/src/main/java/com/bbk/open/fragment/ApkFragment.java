 ...
 */
public class ApkFragment extends Fragment implements View.OnTouchListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public static ApkFragment getInstance() {
        ApkFragment appFragment = new ApkFragment();
        return appFragment;
    }
    ...
    public void updateContent(String content) {
        if (TextUtils.isEmpty(content)) {
            ...
            try {
                result = dao.qurry(content, FileInfo.TYPE_INSTALL);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (intent != null) {
            ...
            Toast.makeText(context, "该安装包已被删除", Toast.LENGTH_LONG).show();
        ...
        builder.setItems(R.array.thread_menu, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == 0) {
                    ...
                    Toast.makeText(context, "该安装包已被隐藏，可在隐藏空间中恢复", Toast.LENGTH_LONG).show();
                } else {
